...
<?php $__env->startSection('title', 'Validation d\'achat - Formation'); ?>
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="bg-white rounded-xl shadow-sm p-8 border border-gray-100 text-center">
        ...
        <div class="space-y-3">
            <a href="<?php echo e(route('formations.show', $formation->slug)); ?>" class="btn btn-primary w-full">Commencer la formation</a>
            <a href="<?php echo e(route('formations.my')); ?>" class="btn btn-secondary w-full">Voir mes formations</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/formations/validation.blade.php ENDPATH**/ ?>