...
<?php $__env->startSection('title', 'Mobile Money en attente - CodeLearn'); ?>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            <div class="border rounded-lg p-6 mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold"><?php echo e($payment->phone_number); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Opérateur :</span>
                        <span class="font-bold"><?php echo e($payment->operator); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Montant :</span>
                        <!-- AFFICHER EN MGA -->
                        <span class="text-xl font-bold text-primary-600"><?php echo e(number_format($payment->amount, 0)); ?> MGA</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        ?>
                        <span class="font-mono font-bold">CODELEARN<?php echo e(strtoupper($plan)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
                ...
                <?php if(config('app.debug') && session('fallback_validation_code')): ?>
                    <div class="mb-4 rounded-md border border-amber-300 bg-amber-50 p-3 text-sm text-amber-800">
                        Mode test: code de validation <strong><?php echo e(session('fallback_validation_code')); ?></strong>
                    </div>
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('subscription.confirm-mobile-money', $payment->id)); ?>" class="flex flex-col sm:flex-row gap-3">
                    <?php echo csrf_field(); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <button type="button" onclick="checkPaymentStatus('<?php echo e($payment->id); ?>')" class="btn btn-primary flex-1">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function autoCheck() {
            ...
            // CORRIGÉ: Utiliser la route correcte
            fetch(`/abonnement/verifier/<?php echo e($payment->id); ?>`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Erreur réseau');
                    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/subscription/mobile-money-waiting.blade.php ENDPATH**/ ?>