...
<?php $__env->startSection('title', 'Annuler l\'abonnement - CodeLearn'); ?>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            ...
            <div class="p-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <p class="font-bold text-gray-900">
                                    <?php echo e(auth()->user()->subscription_expires_at->format('d/m/Y')); ?>
                            ...
                            <div>
                                ...
                                <p class="font-bold text-primary-600">
                                    <?php echo e(now()->diffInDays(auth()->user()->subscription_expires_at)); ?> jours
                                </p>
                            </div>
                        </div>
                ...
                <!-- Cancellation Form -->
                <form method="POST" action="<?php echo e(route('subscription.confirm-cancel')); ?>" id="cancel-form">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <ul class="text-yellow-700 space-y-2 text-sm">
                                        <li>• Votre abonnement restera actif jusqu'au <?php echo e(auth()->user()->subscription_expires_at->format('d/m/Y')); ?></li>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('subscription.manage')); ?>" class="btn btn-outline flex-1">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="border-2 border-primary-200 rounded-xl p-6 bg-gradient-to-br from-primary-50 to-white">
                    ...
                    <a href="<?php echo e(route('subscription.plans')); ?>" class="btn btn-primary w-full">
        ...
        <div class="mt-8 text-center">
            <p class="text-gray-600">
                ...
                Des questions ? Notre 
                <a href="<?php echo e(route('support')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">équipe support</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/subscription/cancel.blade.php ENDPATH**/ ?>