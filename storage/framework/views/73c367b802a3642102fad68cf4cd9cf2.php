            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="grid md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e($submission->ai_score); ?>%</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Modèle</p>
                        <p class="text-sm font-medium text-gray-900"><?php echo e($submission->ai_model ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Intervention humaine</p>
                        <p class="text-sm font-medium <?php echo e($submission->ai_requires_human_review ? 'text-orange-600' : 'text-emerald-600'); ?>">
                            <?php echo e($submission->ai_requires_human_review ? 'Recommandée' : 'Non requise'); ?>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-800 whitespace-pre-line"><?php echo e($submission->ai_feedback); ?></p>
                </div>
            </div>
        <?php endif; ?>
