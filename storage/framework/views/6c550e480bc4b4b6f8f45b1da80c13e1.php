...
<?php $__env->startSection('title', 'Paiement Crypto - CodeLearn'); ?>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">Taux: $<?php echo e(number_format($cryptoRates['btc'] ?? 45000, 0)); ?></div>
                                </div>
                            </div>
                            <div class="text-right">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">Taux: $<?php echo e(number_format($cryptoRates['eth'] ?? 3000, 0)); ?></div>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="font-mono font-bold">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <form method="POST" action="<?php echo e(route('subscription.process-crypto')); ?>" id="crypto-form">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/subscription/crypto.blade.php ENDPATH**/ ?>