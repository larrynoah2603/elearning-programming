...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            <form method="GET" action="<?php echo e(route('lessons.index')); ?>" class="grid md:grid-cols-3 gap-4">
                <div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card-hover bg-white rounded-xl shadow-sm overflow-hidden <?php echo e($lesson->access_level == 'subscribed' && (!auth()->check() || !auth()->user()->isSubscribed()) ? 'opacity-75' : ''); ?>">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo e($lesson->title); ?></h3>
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($lesson->description, 120)); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/lessons/index.blade.php ENDPATH**/ ?>