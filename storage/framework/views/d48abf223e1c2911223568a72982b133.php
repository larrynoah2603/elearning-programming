        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="animate-fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('exercises.index')); ?>" class="btn btn-primary bg-white text-primary-700 hover:bg-gray-100 px-8 py-4 text-lg">
                        <i class="fas fa-play mr-2"></i> Commencer gratuitement
                    </a>
                    <a href="<?php echo e(route('subscription.plans')); ?>" class="btn border-2 border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                ...
                <div class="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-white/20">
                    <div>
                        <div class="text-3xl font-bold"><?php echo e($stats['lessons'] ?? '50+'); ?></div>
                        <div class="text-primary-200 text-sm">Leçons</div>
                    </div>
                    <div>
                        <div class="text-3xl font-bold"><?php echo e($stats['exercises'] ?? '200+'); ?></div>
                        <div class="text-primary-200 text-sm">Exercices</div>
                    </div>
                    <div>
                        <div class="text-3xl font-bold"><?php echo e($stats['videos'] ?? '100+'); ?></div>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12">
            ...
            <a href="<?php echo e(route('exercises.index')); ?>" class="mt-4 lg:mt-0 text-primary-600 hover:text-primary-700 font-medium flex items-center">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $featuredExercises ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="card-hover bg-white rounded-xl shadow-sm overflow-hidden">
                        <div class="p-6">
                            ...
                            <h4 class="font-bold text-gray-900 mb-2"><?php echo e($exercise->title); ?></h4>
                            <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($exercise->description, 100)); ?></p>
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-500">
                                    <i class="fas fa-star text-yellow-400 mr-1"></i> <?php echo e($exercise->points); ?> pts
                                </span>
                                <a href="<?php echo e(route('exercises.show', $exercise->slug)); ?>" class="text-primary-600 hover:text-primary-700 text-sm font-medium">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $featuredLessons ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="card-hover bg-white rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            <span class="badge badge-<?php echo e($lesson->level_badge_color); ?> mb-3">
                                <?php echo e($lesson->level_display); ?>

                            </span>
                            <h4 class="font-bold text-gray-900 mb-2"><?php echo e($lesson->title); ?></h4>
...
<section class="py-20 bg-gradient-to-br from-secondary-600 to-primary-700 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <a href="<?php echo e(route('subscription.plans')); ?>" class="btn bg-white text-primary-700 hover:bg-gray-100 px-10 py-4 text-lg">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('categories.show', $category->slug)); ?>" class="card-hover group bg-gray-50 rounded-xl p-6 flex items-center space-x-4">
                    <div class="w-16 h-16 bg-white rounded-xl shadow-sm flex items-center justify-center group-hover:shadow-md transition-shadow">
                        <i class="fas <?php echo e($category->icon ?? 'fa-code'); ?> text-3xl text-primary-600"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-900 group-hover:text-primary-600 transition-colors"><?php echo e($category->name); ?></h3>
                        <p class="text-gray-500 text-sm"><?php echo e($category->lessons_count); ?> leçons</p>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
