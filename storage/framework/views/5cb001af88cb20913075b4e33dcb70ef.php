...
<?php $__env->startSection('title', 'Paiement par Carte - CodeLearn'); ?>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center pb-4 border-b">
                        <div>
                            <h3 class="font-medium text-gray-900">Abonnement <?php echo e($planDetails['name']); ?></h3>
                            <p class="text-sm text-gray-500"><?php echo e($planDetails['days']); ?> jours</p>
                        </div>
                        <div class="text-right">
                            <div class="text-lg font-bold text-primary-600"><?php echo e(number_format($planDetails['price'], 0)); ?> FCFA</div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <form method="POST" action="<?php echo e(route('subscription.process-card')); ?>" id="card-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6">
                        <label class="flex items-start">
                            ...
                            <span class="ml-2 text-sm text-gray-600">
                                J'autorise le prélèvement de <?php echo e(number_format($planDetails['price'], 0)); ?> FCFA sur ma carte.
                    ...
                    <button type="submit" class="btn btn-primary w-full py-3">
                        <i class="fas fa-lock mr-2"></i> Payer <?php echo e(number_format($planDetails['price'], 0)); ?> FCFA
                    </button>
                </form>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/subscription/card.blade.php ENDPATH**/ ?>