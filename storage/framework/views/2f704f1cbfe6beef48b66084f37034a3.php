            ...
            <div class="border-b pb-4 mb-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-primary-600"><?php echo e(number_format($planDetails['price'], 0)); ?> Ar</p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm"><?php echo e(number_format($planDetails['price'], 0)); ?> Ar</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $mobileMoneyOperators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $operator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                                ...
                                <div class="ml-3">
                                    ...
                                    <span class="block text-xs text-gray-500">Préfixes: <?php echo e(implode(', ', $operator['number_prefix'])); ?></span>
                                </div>
                            </label>
                ...
                <div class="mb-6">
                    <label class="flex items-start">
                        ...
                        <span class="ml-2 text-sm text-gray-600">
                            J'autorise le prélèvement de <?php echo e(number_format($planDetails['price'], 0)); ?> Ar sur mon compte Mobile Money
