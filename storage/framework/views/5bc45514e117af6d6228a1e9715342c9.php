...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
            ...
            <a href="<?php echo e(route('formations.my')); ?>" class="bg-white rounded-xl shadow-sm p-6 flex items-center hover:bg-gray-50 transition-colors">
                ...
                <div>
                    <div class="text-3xl font-bold text-gray-900"><?php echo e($stats['purchased_formations'] ?? 0); ?></div>
