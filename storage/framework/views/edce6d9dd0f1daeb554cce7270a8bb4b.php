...
<div class="bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="prose prose-lg prose-gray dark:prose-invert max-w-none">
            ...
            <p class="text-gray-600 mb-8"><strong>Date de la dernière mise à jour :</strong> <?php echo e(date('d F Y')); ?></p>
            ...
            <p>
                Pour exercer ces droits, veuillez nous contacter à <strong><?php echo e(config('mail.from.address')); ?></strong>.
            </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/legal/privacy.blade.php ENDPATH**/ ?>