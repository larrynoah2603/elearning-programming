...
<?php $__env->startSection('title', 'Gérer mon abonnement - CodeLearn'); ?>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-8">
                        <div class="border rounded-lg p-5">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-gray-900">Formule <?php echo e(ucfirst($subscription->plan)); ?></h3>
                                    <p class="text-gray-600 text-sm">
                                        <?php if($subscription->plan === 'monthly'): ?>
                                            Mensuel
                                        <?php elseif($subscription->plan === 'quarterly'): ?>
                                            Trimestriel
                                        <?php else: ?>
                                            Annuel
                                        <?php endif; ?>
                        ...
                        <div class="border rounded-lg p-5">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium"><?php echo e($subscription->start_date->format('d/m/Y')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Fin :</span>
                                    <span class="font-medium"><?php echo e($subscription->end_date->format('d/m/Y')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Jours restants :</span>
                                    <span class="font-bold text-primary-600">
                                        <?php echo e(now()->diffInDays($subscription->end_date)); ?> jours
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex justify-between mt-2 text-sm text-gray-500">
                            <span>Début : <?php echo e($subscription->start_date->format('d/m/Y')); ?></span>
                            <span>Fin : <?php echo e($subscription->end_date->format('d/m/Y')); ?></span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <?php if($subscription->plan === 'yearly'): ?>
                                <div class="flex items-center">
                                    <i class="fas fa-check text-green-500 mr-3"></i>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <?php if($payments->count() > 0): ?>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $payments->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($payments->count() > 3): ?>
                                <div class="text-center pt-2">
                                    <a href="<?php echo e(route('subscription.payment-history')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">
                                        Voir tous les paiements (<?php echo e($payments->count()); ?>)
                                    </a>
                                </div>
                            <?php endif; ?>
                        </div>
            ...
            <div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
                    ...
                    <div class="space-y-4">
                        <!-- Renew Button -->
                        <a href="<?php echo e(route('subscription.plans')); ?>" class="flex items-center justify-between p-4 border rounded-lg hover:bg-primary-50 hover:border-primary-300 transition-colors">
                            <div class="flex items-center">
                        ...
                        <!-- Upgrade/Downgrade -->
                        <a href="<?php echo e(route('subscription.plans')); ?>" class="flex items-center justify-between p-4 border rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors">
                            <div class="flex items-center">
                        ...
                        <!-- Cancel Button -->
                        <a href="<?php echo e(route('subscription.cancel')); ?>" class="flex items-center justify-between p-4 border rounded-lg hover:bg-red-50 hover:border-red-300 transition-colors">
                            <div class="flex items-center">
                        ...
                        <!-- Download Invoices -->
                        <a href="<?php echo e(route('subscription.payment-history')); ?>" class="flex items-center justify-between p-4 border rounded-lg hover:bg-green-50 hover:border-green-300 transition-colors">
                            <div class="flex items-center">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900"><?php echo e($user->created_at->format('d/m/Y')); ?></p>
                        </div>
                    </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-6">
                    ...
                    <a href="<?php echo e(route('support')); ?>" class="btn btn-primary w-full">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/subscription/manage.blade.php ENDPATH**/ ?>