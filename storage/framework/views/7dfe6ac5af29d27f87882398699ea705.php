...
<?php $__env->startSection('title', $category->name . ' - CodeLearn'); ?>

<?php $__env->startSection('content'); ?>
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Avertissement pour les leçons premium non accessibles -->
        <?php if(($hasPremiumLessons ?? false) && (!auth()->check() || !auth()->user()?->isSubscribed())): ?>
            <div class="bg-gradient-to-r from-warning-500 to-orange-600 rounded-xl p-6 mb-6 text-white">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <a href="<?php echo e(route('subscription.plans')); ?>" class="btn bg-white text-warning-700 hover:bg-gray-100">
        ...
        <nav class="flex items-center text-sm text-gray-500 mb-6">
            ...
            <a href="<?php echo e(route('categories.index')); ?>" class="hover:text-primary-600">Catégories</a>
            <i class="fas fa-chevron-right mx-2 text-xs"></i>
        ...
        <div class="bg-gradient-to-r from-primary-500 to-secondary-600 rounded-xl p-8 mb-8 text-white">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold mb-2"><?php echo e($category->name); ?></h1>
                    <p class="text-white/90"><?php echo e($category->description); ?></p>
                    <p class="text-white/80 text-sm mt-2">
                        <i class="fas fa-graduation-cap mr-1"></i> <?php echo e($category->lessons_count ?? 0); ?> leçons disponibles
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            <div class="bg-white rounded-xl shadow-sm p-6">
                <form method="GET" action="<?php echo e(route('categories.show', $category->slug)); ?>" class="space-y-4">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('lessons.index')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">
            ...
            <?php if($lessons->count() > 0): ?>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card-hover bg-white rounded-xl shadow-sm overflow-hidden <?php echo e($lesson->access_level == 'subscribed' && (!auth()->check() || !auth()->user()->isSubscribed()) ? 'opacity-75' : ''); ?>">
                            ...
                            <div class="p-6">
                                ...
                                <h3 class="text-lg font-bold text-gray-900 mb-2">
                                    <a href="<?php echo e(route('lessons.show', $lesson->slug)); ?>" class="hover:text-primary-600 transition-colors">
                                        <?php echo e($lesson->title); ?>

                                    </a>
                                </h3>
                                
                                <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($lesson->description, 100)); ?></p>

                                <div class="flex items-center justify-between text-sm text-gray-500 mb-4">
                                    <?php if($lesson->page_count): ?>
                                        <span><i class="fas fa-file-alt mr-1"></i> <?php echo e($lesson->page_count); ?> pages</span>
                                    <?php endif; ?>
                                    <span>
                                        <i class="fas fa-dumbbell mr-1"></i> <?php echo e($lesson->exercises_count ?? 0); ?> exercices
                                    </span>
                                </div>

                                <?php if($lesson->access_level == 'subscribed' && (!auth()->check() || !auth()->user()->isSubscribed())): ?>
                                    <a href="<?php echo e(route('subscription.plans')); ?>" class="btn btn-secondary w-full">
                                        <i class="fas fa-lock mr-2"></i> Débloquer
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('lessons.show', $lesson->slug)); ?>" class="btn btn-primary w-full">
                ...
                <div class="text-center py-16 bg-white rounded-xl shadow-sm">
                    ...
                    <h3 class="text-xl font-medium text-gray-900 mb-2">
                        <?php if(request('search')): ?>
                            Aucune leçon trouvée pour "<?php echo e(request('search')); ?>"
                        <?php else: ?>
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('categories.show', $category->slug)); ?>" class="mt-4 inline-block text-primary-600 hover:text-primary-700">
            ...
            <div class="bg-gray-50 rounded-xl p-8">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $otherCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('categories.show', $otherCategory->slug)); ?>" 
                           class="card-hover group bg-white rounded-xl p-6 flex items-center space-x-4">
                            <div class="w-14 h-14 bg-gradient-to-br from-primary-500 to-secondary-600 rounded-xl flex items-center justify-center text-white text-xl">
                                <i class="<?php echo e($otherCategory->icon ?? 'fas fa-folder'); ?>"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 group-hover:text-primary-600 transition-colors">
                                    <?php echo e($otherCategory->name); ?>

                                </h4>
                                <p class="text-gray-500 text-sm"><?php echo e($otherCategory->lessons_count); ?> leçons</p>
                            </div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/categories/show.blade.php ENDPATH**/ ?>