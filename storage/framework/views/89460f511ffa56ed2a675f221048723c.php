...
<?php $__env->startSection('title', 'Virement en attente - CodeLearn'); ?>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            <div class="border rounded-lg p-6 mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between">
                        ...
                        <span class="font-mono font-bold">CODE-<?php echo e(strtoupper($plan)); ?>-<?php echo e(auth()->user()->id); ?>-<?php echo e(date('Ymd')); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Abonnement :</span>
                        <span class="font-bold"><?php echo e($planDetails['name']); ?> (<?php echo e($planDetails['days']); ?> jours)</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Montant :</span>
                        <span class="text-xl font-bold text-primary-600"><?php echo e(number_format($planDetails['price'], 0)); ?> FCFA</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Date prévue :</span>
                        <span class="font-medium"><?php echo e(session('transfer_date', date('d/m/Y'))); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Votre banque :</span>
                        <span class="font-medium"><?php echo e(session('bank_name', 'Non spécifiée')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
                ...
                <ol class="text-yellow-700 space-y-3">
                    <li class="flex items-start">
                        ...
                        <span>Effectuez le virement avec la référence <strong>CODE-<?php echo e(strtoupper($plan)); ?>-<?php echo e(auth()->user()->id); ?>-<?php echo e(date('Ymd')); ?></strong></span>
                    </li>
                    <li class="flex items-start">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline flex-1">
                    <i class="fas fa-home mr-2"></i> Tableau de bord
                </a>
                <a href="mailto:paiement@codelearn.com?subject=Reçu virement CODE-<?php echo e(strtoupper($plan)); ?>-<?php echo e(auth()->user()->id); ?>-<?php echo e(date('Ymd')); ?>" 
...
<script>
    function sendReceipt() {
        ...
        window.location.href = 'mailto:paiement@codelearn.com?subject=Reçu%20virement%20CODE-<?php echo e(strtoupper($plan)); ?>-<?php echo e(auth()->user()->id); ?>-<?php echo e(date('Ymd')); ?>&body=Bonjour,%0D%0A%0D%0AVeuillez trouver ci-joint le reçu de mon virement.%0D%0A%0D%0ARéférence : CODE-<?php echo e(strtoupper($plan)); ?>-<?php echo e(auth()->user()->id); ?>-<?php echo e(date('Ymd')); ?>%0D%0AMontant : <?php echo e(number_format($planDetails['price'], 0)); ?> FCFA%0D%0ANom : <?php echo e(auth()->user()->name); ?>%0D%0A%0D%0ACordialement';
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function checkPaymentStatus() {
            ...
            // fetch('/api/payment/status/<?php echo e(session('payment_id')); ?>')
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\elearning-programming\resources\views/subscription/bank.blade.php ENDPATH**/ ?>