...
<div class="py-8">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="surface-glow rounded-2xl p-6 bg-gradient-to-r from-primary-50 via-white to-secondary-50 dark:from-slate-800 dark:via-slate-800 dark:to-slate-700">
            ...
            <div class="surface-glow rounded-2xl p-6">
                ...
                <div class="space-y-3">
                    @forelse($challenges as $challenge)
                        <a href="{{ route('exercises.show', $challenge->slug) }}" class="block p-4 rounded-xl border border-gray-100 dark:border-slate-700 hover:border-primary-200 dark:hover:border-primary-500 hover:bg-primary-50/40 dark:hover:bg-slate-700/60 transition-all duration-200 card-float">
            ...
            <div class="surface-glow rounded-2xl p-6">
                ...
                <div class="space-y-2">
                    @forelse($leaderboard as $index => $row)
                        <div class="flex justify-between items-center rounded-lg px-3 py-2 {{ $index < 3 ? 'bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/30' : 'border-b border-gray-100 dark:border-slate-700' }} text-sm">
