            ...
            <div class="border rounded-lg p-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-xl font-bold text-primary-600">{{ number_format($planDetails['price'], 0) }} Ar</span>
                    </div>
                    <div class="flex justify-between">
