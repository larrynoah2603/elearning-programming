...
@section('title', 'Nos Offres - CodeLearn')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            @foreach($plans as $plan)
                <div class="relative {{ $plan['highlighted'] ? 'transform md:-translate-y-4' : '' }}">
                    @if($plan['highlighted'])
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden {{ $plan['highlighted'] ? 'ring-4 ring-primary-500' : '' }}">
                        <div class="p-8">
                            ...
                            <div class="text-sm text-gray-500 mb-2">
                                ≈ ${{ number_format($plan['price_usd'] ?? 0, 2) }} USD
                            </div>
                            ...
                            @else
                                <a href="{{ route('subscription.checkout', $plan['id']) }}" class="btn {{ $plan['highlighted'] ? 'btn-primary' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} w-full py-3">
                                    <i class="fas fa-crown mr-2"></i> Choisir {{ $plan['name'] }}
                                </a>
                            @endif
                        </div>
                    </div>
