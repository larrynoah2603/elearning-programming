...
@section('title', 'Paiement - CodeLearn')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div class="flex-1">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-900">Abonnement {{ $planDetails['name'] }}</h3>
                            <p class="text-gray-600">{{ $planDetails['days'] }} jours d'accès</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center md:text-right">
                    ...
                    <div class="text-3xl font-bold text-primary-600">{{ number_format($planDetails['price'], 0) }} MGA</div>
                    <!-- CORRECTION ICI : utiliser price_usd si disponible -->
                    <p class="text-gray-500">soit ${{ number_format($planDetails['price_usd'] ?? ($planDetails['price'] / 4500), 2) }} USD</p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <!-- Card Payment -->
                <a href="{{ route('subscription.card', $plan) }}" 
                ...
                <!-- Mobile Money -->
                <a href="{{ route('subscription.mobile-money', $plan) }}" 
                ...
                <!-- Crypto -->
                <a href="{{ route('subscription.crypto', $plan) }}" 
                ...
                <!-- Bank Transfer -->
                <a href="{{ route('subscription.bank', $plan) }}" 
            ...
            <div class="flex justify-between pt-6 border-t">
                <a href="{{ route('subscription.plans') }}" class="btn btn-outline">
