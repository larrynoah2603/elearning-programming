...
@section('title', 'Paiement Mobile Money - CodeLearn')
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            <div class="border-b pb-4 mb-6">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p class="font-medium text-gray-900">Abonnement {{ $planDetails['name'] }}</p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">Code : <span class="font-mono font-bold">CODELEARN{{ strtoupper($plan) }}</span></p>
                        </div>
                    </div>
            ...
            <!-- Payment Form -->
            <form method="POST" action="{{ route('subscription.process-mobile-money') }}" id="mobile-money-form">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        @foreach($mobileMoneyOperators as $key => $operator)
                            <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="operator" value="{{ $key }}" 
