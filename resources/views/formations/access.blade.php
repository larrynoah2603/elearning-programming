...
@section('title', 'Accès à la formation')
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="bg-white rounded-xl shadow-sm p-8 border border-gray-100 text-center">
        ...
        <div class="space-y-3">
            <a href="{{ route('formations.show', $formation->slug) }}" class="btn btn-primary w-full">Voir le programme</a>
            <a href="{{ route('formations.my') }}" class="btn btn-secondary w-full">Mes formations</a>
        </div>
    </div>
</div>
@endsection